...
;------------------------------------------------------------
;flagsstr                  Allocated to stack - _bp -5
...
;f                         Allocated to stack - _bp +3
;------------------------------------------------------------
;	../../core/net/tcpdump.c:161: n(uint16_t num, char *ptr)
;	-----------------------------------------
;	 function n
;	-----------------------------------------
_n:
...
;------------------------------------------------------------
;packetlen                 Allocated to stack - _bp -4
;buf                       Allocated to stack - _bp -7
;buflen                    Allocated to stack - _bp -9
;packet                    Allocated to stack - _bp +1
;flags                     Allocated to stack - _bp +4
;sloc0                     Allocated to stack - _bp +12
;------------------------------------------------------------
;	../../core/net/tcpdump.c:198: tcpdump_format(uint8_t *packet, uint16_t packetlen,
;	-----------------------------------------
...
;	../../core/net/tcpdump.c:248: n(IPBUF->srcipaddr[3], d(
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/tcpdump.c:247: n(uip_htons(UDPBUF->srcport), d(
	mov	r0,_bp
	inc	r0
	mov	ar2,@r0
	inc	r0
...
;	../../core/net/tcpdump.c:242: n(IPBUF->destipaddr[3], d(
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/tcpdump.c:241: n(uip_htons(UDPBUF->destport), d(
	mov	r0,_bp
	inc	r0
	mov	ar2,@r0
	inc	r0
...
;	../../core/net/tcpdump.c:271: n(IPBUF->srcipaddr[3], d(
	...
	inc	r0
	mov	@r0,b
;	../../core/net/tcpdump.c:270: n(uip_htons(TCPBUF->srcport), d(
	mov	r0,_bp
	inc	r0
	mov	ar2,@r0
	inc	r0
...
;	../../core/net/tcpdump.c:265: n(IPBUF->destipaddr[3], d(
	...
	inc	r0
	mov	@r0,b
;	../../core/net/tcpdump.c:264: n(uip_htons(TCPBUF->destport), d(
	mov	r0,_bp
	inc	r0
	mov	ar2,@r0
	inc	r0
