...
;status                    Allocated to stack - _bp -7
;num_tx                    Allocated to stack - _bp -9
;sent                      Allocated to registers r6 r7 
;------------------------------------------------------------
;	../../core/net/mac/mac.c:46: mac_call_sent_callback(mac_callback_t sent, void *ptr, int status, int num_tx)
;	-----------------------------------------
...
_mac_call_sent_callback:
	...
	mov	r6,dpl
	mov	r7,dph
;	../../core/net/mac/mac.c:64: if(sent) {
	mov	a,r6
	orl	a,r7
	jz	00108$
;	../../core/net/mac/mac.c:65: sent(ptr, status, num_tx);
	push	ar7
	push	ar6
	mov	a,_bp
	add	a,#0xf7
