...
;nptr                      Allocated to stack - _bp +4
;nameptr                   Allocated to stack - _bp +7
;i                         Allocated to registers r7 
;n                         Allocated to registers r3 
;namemapptr                Allocated to stack - _bp +10
...
;	../../core/net/resolv.c:239: memset(hdr, 0, sizeof(struct dns_hdr));
	...
	dec	sp
	pop	ar7
;	../../core/net/resolv.c:240: hdr->id = uip_htons(i);
	mov	ar4,r7
	mov	r5,#0x00
	mov	dpl,r4
	mov	dph,r5
...
;	../../core/net/resolv.c:241: hdr->flags1 = DNS_FLAG1_RD;
	...
	mov	a,#0x01
	lcall	__gptrput
;	../../core/net/resolv.c:242: hdr->numquestions = UIP_HTONS(1);
	mov	r0,_bp
	inc	r0
	mov	a,#0x04
	add	a,@r0
...
;hdr                       Allocated to stack - _bp +1
;namemapptr                Allocated to stack - _bp +4
;sloc0                     Allocated to stack - _bp +13
...
;	../../core/net/resolv.c:283: hdr = (struct dns_hdr *)uip_appdata;
	...
	inc	r0
	mov	@r0,ar7
;	../../core/net/resolv.c:296: i = (uint8_t)uip_htons(hdr->id);
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	inc	r0
...
;	../../core/net/resolv.c:309: return;
	ljmp	00121$
00102$:
;	../../core/net/resolv.c:314: nquestions = (uint8_t)uip_htons(hdr->numquestions);
	mov	r0,_bp
	inc	r0
	mov	a,#0x04
	add	a,@r0
	...
	mov	a,r5
	movx	@dptr,a
;	../../core/net/resolv.c:315: nanswers = (uint8_t)uip_htons(hdr->numanswers);
	mov	r0,_bp
	inc	r0
	mov	a,#0x06
	add	a,@r0
...
;	../../core/net/resolv.c:334: ans = (struct dns_answer *)nameptr;
	...
	mov	ar4,r5
	mov	ar7,r6
;	../../core/net/resolv.c:341: if(ans->type == UIP_HTONS(1) &&
	push	ar3
	push	ar5
	push	ar6
	mov	dpl,r2
...
00152$:
	...
	ljmp	00107$
00153$:
;	../../core/net/resolv.c:342: ans->class == UIP_HTONS(1) &&
	mov	a,#0x02
	add	a,r2
	mov	r3,a
	clr	a
...
00154$:
	...
	ljmp	00107$
00155$:
;	../../core/net/resolv.c:343: ans->len == UIP_HTONS(4)) {
	mov	a,#0x08
	add	a,r2
	mov	r3,a
	clr	a
...
;	../../core/net/resolv.c:356: return;
	sjmp	00121$
00107$:
;	../../core/net/resolv.c:358: nameptr = nameptr + 10 + uip_htons(ans->len);
	mov	a,_bp
	add	a,#0x0a
	mov	r0,a
	mov	a,#0x0A
...
;	../../core/net/resolv.c:392: uip_udp_remove(resolv_conn);
	...
	lcall	__gptrput
00111$:
;	../../core/net/resolv.c:394: resolv_conn = udp_new((uip_ipaddr_t *)data, UIP_HTONS(53), NULL);
	mov	a,_bp
	add	a,#0xfa
	mov	r0,a
	mov	ar2,@r0
...
00175$:
	ljmp	00127$
00176$:
;	../../core/net/resolv.c:397: if(uip_udp_conn->rport == UIP_HTONS(53)) {
...
;------------------------------------------------------------
;name                      Allocated to stack - _bp +1
;nameptr                   Allocated to stack - _bp +4
...
;------------------------------------------------------------
;ipaddr                    Allocated to stack - _bp -5
